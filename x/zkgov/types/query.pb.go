...
var fileDescriptor_ac2a1f040192f382 = []byte{
	...
	,
}
...
func (m *QueryCommitmentMerkleProofRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Commitment != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.Commitment))
		i--
		dAtA[i] = 0x8
	}
...
func (m *QueryCommitmentMerkleProofRequest) Size() (n int) {
	...
	_ = l
	if m.Commitment != 0 {
		n += 1 + sovQuery(uint64(m.Commitment))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Commitment |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
